...
import styles from '../styles/SupplierMobile.module.css'
...
export default function SupplierDashboard() {
    ...
    return (
        <div className={styles.container}>
            ...
            {/* Profile Sidebar Wrapper Content */}
            {/* The sidebar is hidden on mobile in favor of bottom nav */}
            ...
            <nav className={styles.bottomNav}>
                ...
                <button
                    className={`${styles.navBtn} ${activeTab === 'products' ? styles.navActive : ''}`}
                ...
                >
                    <div className={styles.navIconWrapper}>
                        ...
                        {stats.pendingOrders > 0 && <span className={styles.navBadge}>{stats.pendingOrders}</span>}
                    </div>
                    <span className={styles.navLabel}>Orders</span>
                </button>
                <button
                    className={`${styles.navBtn} ${activeTab === 'payments' ? styles.navActive : ''}`}
                ...
                >
                    <div className={styles.navIconWrapper}>
                        {profileAvatar ? <img src={profileAvatar} alt="Me" style={{ width: '24px', height: '24px', borderRadius: '50%', objectFit: 'cover' }} /> : (
